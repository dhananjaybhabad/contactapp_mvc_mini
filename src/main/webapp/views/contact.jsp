...
<title>www.dhananjaybhabad.com</title>
<script>
				...
				<c:forEach items="${contact}" var="cot">
					<tr>
						...
						<td><a href="edit?contactId=${cot.contactId }"><label
								style="color: Green; font-size: 20px;">EDIT</label></a></td>
						<td><a href="delete?contactId=${cot.contactId }"
							onclick="return confirmDelete()"> <label
								style="color: Red; font-size: 20px;">Delete</label></a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
